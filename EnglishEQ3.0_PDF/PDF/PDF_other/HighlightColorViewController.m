...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    if (annotHighlightColor == 0xFFFF0000) currentIndex =0;
    
    if (annotHighlightColor == 0xFF000000)currentIndex =1;
    if (annotHighlightColor == 0xFF0000FF)currentIndex =2;
    if (annotHighlightColor == 0xFFFFFF00)currentIndex =3;
    if (annotHighlightColor == 0xFFFFFFFF)currentIndex =4;
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    switch (indexPath.row) {
        case 0:
            annotHighlightColor = 0xFFFF0000;
            break;
        case 1:
            annotHighlightColor = 0xFF000000;
            break;
        case 2:
            annotHighlightColor = 0xFF0000FF;
            break;
        case 3:
            annotHighlightColor = 0xFFFFFF00;
            break;
        case 4:
            annotHighlightColor = 0xFFFFFFFF;
            break;
        default:
            break;
    }
    [userDefaults setInteger:annotHighlightColor forKey:@"HighlightColor"];
    //GEAR
