...
-(void)createToolbarItems
{
    ...
    UIBarButtonItem *nextPageButton = [[UIBarButtonItem alloc]initWithImage:[UIImage imageNamed:@"nextPage"] style:UIBarStyleBlackOpaque target:self action:@selector(nextPage)];
    nextPageButton.width =29;
    UIBarButtonItem *prePageButton = [[UIBarButtonItem alloc]initWithImage:[UIImage imageNamed:@"prePage"] style:UIBarStyleBlackOpaque target:self action:@selector(prePage)];
