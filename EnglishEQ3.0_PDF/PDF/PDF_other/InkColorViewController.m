...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    if (g_ink_color == 0xFFFF0000) currentIndex =0;
    
    if (g_ink_color == 0xFF000000)currentIndex =1;
    if (g_ink_color == 0xFF0000FF)currentIndex =2;
    if (g_ink_color == 0xFFFFFF00)currentIndex =3;
    if (g_ink_color == 0xFFFFFFFF)currentIndex =4;
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    switch (indexPath.row) {
        ...
        case 2:
            ...
            break;
        case 3:
            g_ink_color = 0xFFFFFF00;
            break;
        case 4:
            g_ink_color = 0xFFFFFFFF;
            break;    
        default:
            break;
    }
    [userDefaults setInteger:g_ink_color forKey:@"InkColor"];
    //GEAR
