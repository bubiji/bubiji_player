...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    if (annotStrikeoutColor == 0xFFFF0000) currentIndex =0;
    
    if (annotStrikeoutColor == 0xFF000000)currentIndex =1;
    if (annotStrikeoutColor == 0xFF0000FF)currentIndex =2;
    if (annotStrikeoutColor == 0xFFFFFF00)currentIndex =3;
    if (annotStrikeoutColor == 0xFFFFFFFF)currentIndex =4;
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    switch (indexPath.row) {
        ...
        case 1:
            ...
            break;
        case 2:
            annotStrikeoutColor = 0xFF0000FF;
            break;
        case 3:
            annotStrikeoutColor = 0xFFFFFF00;
            break;
        case 4:
            annotStrikeoutColor = 0xFFFFFFFF;
            break;
        default:
            break;
    }
    [userDefaults setInteger:annotStrikeoutColor forKey:@"StrikeoutColor"];
