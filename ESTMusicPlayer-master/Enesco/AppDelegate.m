...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    [[Zhuge sharedInstance].config setAppVersion:@"Bubiji 2.1-beta"]; // 默认是info.plist中CFBundleShortVersionString值
    ...
    [userDefault setObject:@"tome" forKey:@"group.bubiji.name"];
...
didRegisterForRemoteNotificationsWithDeviceToken:(NSData *)newDeviceToken
{
    ...
    [[Zhuge sharedInstance]registerDeviceToken:newDeviceToken];
...
-(BOOL)loginWith:(NSString *)name wechat:(NSString *)wechat phoneNum:(NSString *)phoneNum{
    if([Helper isLogin]){
        _processVC.tabBarItem = [[UITabBarItem alloc] initWithTitle:@"process" image:[UIImage imageNamed:@"lable_process_normal"] selectedImage:[UIImage imageNamed:@"lable_process_active"]];
        _processVC.tabBarItem.imageInsets = UIEdgeInsetsMake(6,0,-6,0);
        _processVC.tabBarItem.tag = 1;
        [_processVC.tabBarItem setTitlePositionAdjustment: UIOffsetMake(0,-3)];
        _tabBarVC.viewControllers = @[_musicListVC,_processVC];
...
//    else{
//        _loginVC.tabBarItem = [[UITabBarItem alloc] initWithTitle:@"process" image:[UIImage imageNamed:@"lable_process_normal"] selectedImage:[UIImage imageNamed:@"lable_process_active"]];
//        _loginVC.tabBarItem.imageInsets = UIEdgeInsetsMake(6,0,-6,0);
//        _loginVC.tabBarItem.tag = 1;
//        [_loginVC.tabBarItem setTitlePositionAdjustment: UIOffsetMake(0,-3)];
//        _tabBarVC.viewControllers = @[_musicListVC,_loginVC];
//        NSUserDefaults* userDefault = [[NSUserDefaults alloc] initWithSuiteName:@"group.bubiji"];
//        [userDefault setObject:@"username" forKey:name];
//
//    }
