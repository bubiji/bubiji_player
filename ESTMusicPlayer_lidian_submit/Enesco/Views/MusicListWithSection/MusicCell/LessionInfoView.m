...
-(void)setUpDidTimes{
    ...
    self.timesLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, self.frame.size.height -20, self.frame.size.width /3, 20)];
...
-(void)setUpDidDays{
    ...
    self.daysLabel = [[UILabel alloc] initWithFrame:CGRectMake(self.frame.size.width / 3 * 2, self.frame.size.height -20, self.frame.size.width / 3 , 20)];
...
- (void)setRecord:(RecordClass *)record{
    ...
    self.durationLabel.text =[NSString stringWithFormat: @"%ld",record.AllStudyTime];
}
