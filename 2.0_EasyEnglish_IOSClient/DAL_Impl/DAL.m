...
{
    NSString *dbsql =[NSString stringWithFormat:@"update %@ set TodayTime = '%@',DidDays =%ld where ClassID =%ld",tableName,music.TodayTimes,(long)music.DidDays,(long)music.classID];
    [_appDB executeUpdate:dbsql];
}
